...
import net.GingkoTreeX.totem.features.module.NoAttacked;
import net.GingkoTreeX.totem.features.module.Xray;
...
public class Totem {
    ...
    public Totem() {
        ...
        MinecraftForge.EVENT_BUS.register(new NoAttacked());
    }
    public void init(){
        // Register 《事件巴士》
        MinecraftForge.EVENT_BUS.register(this);
